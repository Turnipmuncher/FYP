...
namespace FYP.Droid
{
	[Activity (Label = "FYP", MainLauncher = true, Theme = "@style/AppTheme")]
	public class MainActivity : AppCompatActivity
    {
        ...
        private const string FirebaseURL = "https://fyp-job-hunt-application.firebaseio.com/"; //Firebase Database URL
